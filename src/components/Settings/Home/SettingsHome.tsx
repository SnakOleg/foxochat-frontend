            ...
            {sections[5] && (() => {
                ...
                return (
                    <button
                        ...
                        className={
                            selected === supportSection.key ? styles.menuItemActive : styles.menuItem
                        }
                        onClick={() => onSelect(supportSection.key)}
                        style={{ marginTop: 12 }}
                    >
						<span className={styles.menuIconBg} style={{ background: supportSection.color }}>
							<img src={supportSection.icon} alt="" className={styles.menuIcon}/>
						</span>
